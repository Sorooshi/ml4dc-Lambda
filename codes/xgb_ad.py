...
This is an implementation of "XG-Boost" algorithm for ML4DC studies on CERN data set.
...
def run_the_algorithm(X_train, y_train, X_val, y_val, X_test, y_test,):
    ...
    alg_inst = xgb.XGBClassifier(objective="multi:softprob",
                                 max_depth=10, n_estimators=160,
                                 num_class=2)
    alg_inst.fit(X_train, y_train)
